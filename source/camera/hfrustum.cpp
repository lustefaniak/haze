...
#include "../Haze.h"
#include "hfrustum.h" // class's header file
...
//TODO: copyright
//TODO: źródło: prawdopodobnie nehe
///////////////////////////////// NORMALIZE PLANE \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
/////
...
void HFrustum::NormalizePlane(float frustum[6][4], int side) {
...
void HFrustum::CalculateFrustum() {
...
bool HFrustum::PointInFrustum( float x, float y, float z ) {
...
bool HFrustum::SphereInFrustum( float x, float y, float z, float radius ) {
...
bool HFrustum::CubeInFrustum( float x, float y, float z, float size ) {
